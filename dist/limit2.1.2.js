...
;(function (WIN) {
	...
	var typeWarn = {
		toString: function toString(obj, objStr) {
			return limit.log('warn', obj, 'change into', objStr);
		},
	...
	defineIt('bind', {
		...
		priority: function priority() {
			for (var _len27 = arguments.length, args1 = Array(_len27), _key27 = 0; _key27 < _len27; _key27++) {
				args1[_key27] = arguments[_key27];
			}

			function main() {
				for (var _len28 = arguments.length, args2 = Array(_len28), _key28 = 0; _key28 < _len28; _key28++) {
					args2[_key28] = arguments[_key28];
				}
